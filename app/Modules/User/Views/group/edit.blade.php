...
@section('content_body')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            <form class="form" method="post" action="{{ route('user-group.update') }}" autocomplete="off">
            @csrf
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-xxl-10">
                                    <input class="form-control @error('group') is-invalid @enderror" type="text" name="group" value="{{ old('group') ?: $data->group }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {!! $page->module_roles(['set' => '', 'active' => ''], '', 0, request()->id) !!}
                    </div>
                    </div>
                </div>
